...
const MaxWidthSpan = tw.span`px-6`;

export default ({
  subheading = "Pricing",
  heading = "Flexible Plans.",
  description = "We have a plan to suit every need",
  plans = null,
  ...
  const defaultPlans = [
    {
      name: "Free Plan",
      durationPrices: ["$0", "$0"],
      mainFeature: "Suited for general use and preview",
      features: ["5 Videos per month", "Free 24/7 E-mail support"],
    },
    {
      name: "Basic Plan",
      durationPrices: ["$9", "$99"],
      mainFeature: "Suited for Small Scale Content Creators",
      features: ["60  videos per month", "Quick Chat Responses", "1 Consultation per month", "Priority Assistance"],
      featured: true
    },
    {
      name: "Pro Plan",
      durationPrices: ["$49", "$499"],
      mainFeature: "Suited for People who Love our Product",
      features: ["Unlimited Videos", "Founders Phone Numbers", "5 Consultations per month", "Priority Assistance", "Feature suggestions & Implementations"],
      featured: true
    }
  ];
          ...
          {plans.map((plan, index) => (
            <Plan key={index} featured={plan.featured}>
              <PlanHeader>
                ...
                <MaxWidthSpan className="mainFeature">{plan.mainFeature}</MaxWidthSpan>
              </PlanHeader>
              <PlanFeatures>
