...
export default ({
  ...
  const defaultSteps = [
    ...
    {
      heading: "Grab a Video",
      description: "Paste a Youtube Link to begin trimming and cropping"
    },
    {
      heading: "Download",
      description: "Click Create Video and wait for your freshly created short to be ready for download!"
    }
  ];
