...
export default ({
  ...
  heading = (
    <>
      Designed & Developed for <span tw="text-primary-500">Content Creators.</span>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      Icon: BriefcaseIcon,
      title: "Ease of Use",
      description: "Whether you're an influencer, marketer, or just someone who loves creating and sharing great content.",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Affordable",
      description: "Cheap prices and flexible plans so you can pay in a way to suit your needs!",
